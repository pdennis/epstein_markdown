...
Date: Fri, 10 Jul 2020 20:44:36 +0000

So the estimate from BRG was for less than 30 days, and that was to do everything – extraction plus processing, and I think extraction is the longer part of that. One we get an estimate from PAE, if it’s longer than a few weeks to process, we can go back to BRG and get an estimate on just processing (without extraction) and see what they say. I would guess it would be something like a couple weeks.

(As you can probably tell, I’m trying to catch up on emails from earlier this week!)

From: _________________________ (USANYS) &lt;___________________________&gt;
Sent: Wednesday, July 08, 2020 18:29
To: _________________________ (USANYS) &lt;___________________________&gt;
Subject: RE: Epstein search warrant documents

Do we know how long it would take BRG to do the processing?
...
That’s partially right but not completely – the BRG estimate is for dumping the devices but *also* processing all the data. That is, converting all the Word, Excel, PDF, JPEG, BMP, PPT, etc etc files into a loadable file set for Relativity (specifically, converting to TIFF and load files that can be uploaded).

That intermediate step is something that the FBI had told us they would do, but now are not doing, because they screwed it up so badly last time. So ordinarily we have PAE do the processing, but if they say it will take, say, three months, we can do it faster through BRG.

Either way we’ll review in Relativity, though.

From: _________________________ (USANYS) &lt;___________________________&gt;
Sent: Wednesday, July 08, 2020 17:52
To: _________________________ (USANYS) &lt;___________________________&gt;
Subject: RE: Epstein search warrant documents

I thought the role we wanted BRG to play was the dumping of the devices – I had thought, perhaps incorrectly, that we always planned to use Relatively to review once we were into them. Is that not the case?

From: _________________________ (USANYS) &lt;___________________________&gt;
Sent: Wednesday, July 8, 2020 5:26 PM
To: _________________________ (USANYS) &lt;___________________________&gt;
Subject: RE: Epstein search warrant documents

will hopefully be able to tell us within a few days whether it's very obviously incorrectly formatted. Then the next test will be once it's on Relativity, and that will be an estimate by PAE (or BRG, if they can do it much faster).

From: (USANYS)  $\langle \widehat{\mathbb{C}}\rangle$
Sent: Wednesday, July 08, 2020 16:40
To: (USANYS)  $\langle \widehat{\mathbb{C}}\rangle$
Subject: Re: Epstein search warrant documents

I think probably not if it seems like we're now getting what we need from FBI. When will we know if what FBI gave us today is correctly formatted - will be able to tell us?

Sent from my iPhone

On Jul 8, 2020, at 3:48 PM, (USANYS)  $\langle \widehat{\mathbb{C}}\rangle$  wrote:

Hey, I held off on this after we got the update from FBI, but would it still be useful to do? Totally happy to if so, just wanted to check – thanks.

From: (USANYS)  $\langle \widehat{\mathbb{C}}\rangle$
Sent: Thursday, July 02, 2020 19:15
To: (USANYS)  $\langle \widehat{\mathbb{C}}\rangle$
Cc: (USANYS)  $\langle \widehat{\mathbb{C}}\rangle$  ; (USANYS)  $\langle \widehat{\mathbb{C}}\rangle$
Subject: RE: Epstein search warrant documents
...
On Jun 29, 2020 11:03 AM, "NY [REDACTED]" &lt;[REDACTED] wrote:
[REDACTED],
...
[REDACTED], We are going every other day now, ramping up to 75% week after next. I need drives to put things on like [REDACTED] and I discussed earlier. Once I have those drives, it will take me a couple days to copy stuff. LMK when I can expect the drives. Thanks.
...
On Jun 19, 2020 1:09 PM, "NY [REDACTED]" &lt;[REDACTED] wrote:
...
Cc: [REDACTED] (NY) (FBI) (USANYS) [Contractor]
Subject: RE: Epstein search warrant documents
...
On Jun 1, 2020 4:26 PM, "NY CART Coordinator" and "FBI" wrote: Understood, and thanks for letting us know. Let's keep in touch both on timing and also on whether there's a way to identify and categorize what's already been produced, or if we'll need to just get all the raw data at this stage and go from there.
...
week or 2. Sorry about that. My next day in the office is Thursday, so I'll be able to see if I can easily identify what I already gave you and marry it to a reliable identifier.
...
On Jun 1, 2020 4:13 PM, "____________________" &lt;____________________&gt; wrote: ___________________________.
...
```html
|  From: | ____________________ (NY) (FBI) <____________________>  |
| --- | --- |
|  Sent: | Friday, May 29, 2020 12:53  |
|  To: | ____________________ (NY) (FBI) <____________________>; _________________________ (USANYS) [Contractor] <____________________>  |
|  Cc: | ____________________ (NY) (FBI) <____________________>; _________________________ (NY) (FBI) <____________________>; _________________________ (NY) (FBI) <____________________>  |
|  Subject: | Re: Epstein search warrant documents  |
...
From:  (NY)  (FBI)  (USANYS)  [Contractor]
Sent: Wednesday, May 13, 2020 12:25 PM
To:  (NY) (FBI)  (FBI)  (NY) (FBI)
Subject: RE: Epstein search warrant documents
...
(FBI) &lt;---&gt;; (NY) &lt;---&gt;; (NY) &lt;---&gt;; (NY) &lt;---&gt; Subject: RE: Epstein search warrant documents
...
To: _______________ (USANYS) &lt;---&gt;; _______________ (&gt;); &lt;---&gt;; _______________ (&gt);
(NY) (FBI) &lt;---&gt;; _______________ (USANYS) &lt;---&gt;.
Cc: _______________ (USANYS) [Contractor] &lt;---&gt;; _______________ (&gt);); &lt;---&gt;; _______________ (&gt);
(FBI) &lt;---&gt;.
Subject: RE: Epstein search warrant documents
...
On May 8, 2020 1:58 PM, "_______________________&gt;" &lt;_______________________&gt; wrote: Understood, thanks—it will be great to get that list on Thursday. As a refresh, the info we are looking for is in the attached spreadsheet template.
...
To: _______________ (USANYS) &lt;---&gt;; _______________ (&gt);); &lt;---&gt;; _______________ (&gt);
(NY) (FBI) &lt;---&gt;; _______________ (USANYS) &lt;---&gt;.
Cc: _______________ (USANYS) [Contractor] &lt;---&gt;; _______________ (&gt);); &lt;---&gt;; _______________ (&gt);
(FBI) &lt;---&gt;.
Subject: RE: Epstein search warrant documents
...
Also, _______________, please reach out to me at one of the numbers below so we can brain storm. Thanks.
...
Cc: (USANYS) [Contractor] &lt;;&gt;; (NY) (FBI) &lt;;&gt;; (FBI) &lt;;&gt;
...
[REDACTED] Are you available tomorrow for a conference call to discuss this issue?

SSA [REDACTED]
FBI New York

On Apr 7, 2020 1:55 PM, " [REDACTED]" <br/>
&gt; wrote:
...
To: (NY) (FBI) &lt;&gt;; (USANYS) &lt;&gt;; (USANYS) &lt;&gt;; (USANYS) &lt;&gt;; (USANYS) &lt;&gt;; (USANYS) &lt;&gt;; (USANYS) &lt;&gt;; (USANYS) (FBI) &lt;&gt;
...
From: [mailto:][(USANYS) (FBI) &lt;&gt; (FBI) &lt;&gt; (USANYS) &lt;&gt; (USANYS) &lt;&gt;; (USANYS) &lt;&gt;; (USANYS) &lt;&gt;; (USANYS) (NY) (FBI) &lt;&gt;
...
To: _________________________ (USANYS) &lt;____________________&gt;; _________________________ (NY) (FBI) &lt;____________________&gt;; _________________________ (USANYS) &lt;____________________&gt;;
Cc: _________________________ (USANYS) [Contractor] &lt;____________________&gt;; _________________________ (NY) (FBI) &lt;____________________&gt;;
Subject: RE: Epstein search warrant documents
...
On Mar 2, 2020 11:15 AM, "_________________________," &lt;____________________&gt; wrote:
...
To: _________________________ (NY) (FBI) &lt;____________________&gt;; _________________________ (USANYS) &lt;____________________&gt;; _________________________ (NY) (FBI) &lt;____________________&gt;; _________________________ (USANYS) &lt;____________________&gt;;
Cc: _________________________ (USANYS) [Contractor] &lt;____________________&gt;; _________________________ (NY) (FBI) &lt;____________________&gt;;
Subject: RE: Epstein search warrant documents
...
On Feb 23, 2020 12:21 AM, "NY CART Coordinator" <br/>
[REDACTED] <br/>
[REDACTED] <br/>
= wrote: Team,
