...
From:" (USANYS)"  $\leftarrow$

To:" (USANYS)"  $\leftarrow$

Subject: Re: Epstein search warrant documents

Date: Thu, 02 Jul 2020 23:13:10 +0000

Team has held off on raising but I'll ask them to - given (far higher) BRG budgets has approved on other high profile PCU cases, this seems likely to be unobjectionable. But will find out.

Sent from my iPhone

On Jul 2, 2020, at 6:48 PM, (USANYS)  $\leftarrow$  wrote:

Has said the BRG option is viable?

On Jul 2, 2020, at 6:32 PM, (USANYS)  $\leftarrow$  wrote:
...
From:  $\leftarrow$  Sent: Thursday, July 2, 2020 5:11 PM

To: (USANYS)  $\leftarrow$  Cc: (USANYS)  $\leftarrow$  Subject: RE: Epstein search warrant documents
...
To: (NY) (FBI)'  $\leftarrow$  (USANYS) [Contractor]

Cc: (USANYS)  $\leftarrow$  (NY) (FBI)  $\leftarrow$
...
On Jun 29, 2020 12:56 PM, "  &gt;  wrote: Great, thanks. Is there even a rough estimate of when we will get the USVI materials? Or an estimate of when you'll be able to see how many items to export, so we'll have a better sense of when we'll get those?
...
On Jun 29, 2020 11:03 AM, "NY CART Coordinator" [REDACTED] <[REDACTED] src="https://via.placeholder.com/150x50?text=NY+CART+Coordinator"/></[REDACTED]> wrote: [REDACTED].
...
Cc: [REDACTED] (USANYS) <[REDACTED]>, <[REDACTED]>, (NY) (FBI) <[REDACTED]>, <[REDACTED]>, <[REDACTED]>, <[REDACTED]>, <[REDACTED]>, <[REDACTED]>, <[REDACTED]> <[REDACTED]> <[REDACTED]> <[REDACTED]> <[REDACTED]> <[REDACTED]
...
On Jun 19, 2020 1:09 PM, "NY CART Coordinator" [REDACTED]" <[REDACTED]"> wrote: [REDACTED], following up on the below – please let us know? Given case developments in recent days, this has become urgent. Thanks.

EFTA00027477</[REDACTED]"</[REDACTED]"</[REDACTED]></[REDACTED]></[REDACTED]></[REDACTED]></[REDACTED]></[REDACTED]></[REDACTED]></[REDACTED]></NY></td></tr></table></[REDACTED]>

From: [REDACTED]
Sent: Wednesday, June 17, 2020 14:28
To: [REDACTED] (NY) (FBI) (USANYS) [Contractor]
Cc: [REDACTED] (NY) (FBI) (NY) (USANYS)
Subject: RE: Epstein search warrant documents
...
On Jun 1, 2020 4:26 PM, "NY CART Coordinator" and "CART" were generated by the CART Coordinator. The CART Coordinator wrote: Understood, and thanks for letting us know. Let's keep in touch both on timing and also on whether there's a way to identify and categorize what's already been produced, or if we'll need to just get all the raw data at this stage and go from there.
...
Unfortunately, recent events and our staffing levels have conspired to put a kink in just about everything. If we can't make heads or tails of the stuff I've already produced, we'll do it again. They have told us that our

EFTA00027478

staffing levels will be steadily increasing over the next few weeks, but I'm going to have to push back my estimate by a week or 2. Sorry about that. My next day in the office is Thursday, so I'll be able to see if I can easily identify what I already gave you and marry it to a reliable identifier.
...
From: (NY) (FBI) &lt; Sent: Friday, May 15, 2020 4:11 PM
To: (NY) (FBI) &lt; (USANYS) [Contractor]
Cc: &lt;
...
|  To: | _________________________<_________________________>; (NY) (FBI) <_________________________>; (USANYS) [Contractor]<_________________________>  |
|  Cc: | _________________________<_________________________>; (NY) (FBI) <_________________________>; (NY) (FBI) <_________________________>  |
|  Subject: RE: Epstein search warrant documents  |   |
```

Respectfully, I think there are some miscommunications here – all we have asked is to receive the materials in a format such that we can view them using a system we have access to. We're not able to get web-enabled access through any FBI tool, so we asked for the materials to be transferred in a loadable format so we could put them on Relativity, which both we and the agents can access. We're required to have the files in a format that we can produce them to defense counsel. I've done that in many other cases and it hasn't previously been an issue. My understanding from ________ is that the best way to do it now is just for us (the U.S. Attorney's Office) to get the original files, which our vendor will process—by which I just mean converting into file formats that are loadable onto Relativity. It doesn't really have anything to do with the taint review—we have to have access to the docs in our systems for discovery purposes.

And we were happy to get the materials as they were processed, but when we received the 1.1 million documents earlier this year, they were in a format that wasn't usable for the reasons described in the email I sent on March 9. Again, I understand from ________ that the best way forward is to just get copies of the materials in their original formats, which I understand will be segregated and designated by device. That should work for us! I was just trying to understand the approach, as well as the timeline.

thanks,

```html
|  From: | _________________________<_________________________>; (NY) (FBI) <_________________________>  |
| --- | --- |
...
Relativity is NOT a forensic tool. It is incapable of dealing with many things that are found forensically on a computer like free space, slack space, and system files to name a few. When we started this, and you insisted

EFTA00027481

you do the taint review in Relativity, I warned you that it was adding months worth of work on top of what was already done, and that Relativity was incapable of viewing everything. You insisted we do it this way. So now [REDACTED] and I have come up with a way to fit this round peg into this square hole. We will get it done.
...
To: [REDACTED] (USANYS) [Contractor] [REDACTED] [REDACTED] [REDACTED] [REDACTED] [REDACTED] [REDACTED]
Cc: [REDACTED] [REDACTED] [REDACTED] [REDACTED] [REDACTED] [X] [S] [S] [S]
Subject: RE: Epstein search warrant documents
...
Cc: [REDACTED] (NY) (FBI) [REDACTED] [REDACTED] [X]
Subject: RE: Epstein search warrant documents
...
From: [REDACTED] (NYY) (FBI) <br/>
Sent: Friday, May 8, 2020 2:15 PM

To: [REDACTED], (NYY) (FBI) <br/>
( (NYY) (FBI) <br/>
( (USANYS) <br/>
( (USANYS) <br/>
...
On May 8, 2020 1:58 PM, " [REDACTED]" <br/>
&gt; wrote: Understood, thanks—it will be great to get that list on Thursday. As a refresh, the info we are looking for is in the attached spreadsheet template.
...
To: ☐ (USANYS) &lt;☐&gt;; ☐ (NY) (FBI) &lt;☐&gt;; ☐ (USANYS) &lt;☐&gt;; ☐ (USANYS) &lt;☐&gt;; ☐ (USANYS) &lt;☐&gt;; ☐ (USANYS) &lt;☐&gt;; ☐ (USANYS) &lt;☐&gt;; ☐ (USANYS)
...
To: ☐ (NY) (FBI) &lt;☐&gt;; ☐ (USANYS) &lt;☐&gt;; ☐ (USANYS) &lt;☐&gt;; ☐ (USANYS) &lt;☐&gt;; ☐ (USANYS)
...
To: [REDACTED] (USANYS) [REDACTED] (NY) (FBI) [REDACTED] (USANYS) [REDACTED]
Cc: [REDACTED] (USANYS) [Contractor] [REDACTED] (NY) (USANYS) [REDACTED]
( FBI ) [REDACTED ] (NY) [REDACTED ]
Subject: RE: Epstein search warrant documents
