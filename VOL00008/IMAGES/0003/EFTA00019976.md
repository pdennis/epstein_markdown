...
N.B.: Personal appearance is not required if the requested records are (1) produced by on or before the return date to Special Agent <img alt="Name" src="https://i.imgur.com/8.png"/> , Federal Bureau of Investigation, 26 Federal Plaza, New York, NY 10278, telephone <img alt="Name" src="https://i.imgur.com/9.png"/> ; and (2) accompanied by an executed copy of the attached Declaration of Custodian of Records. PLEASE PROVIDE IN ELECTRONIC FORMAT IF POSSIBLE.

Please contact Forensic Accountant <img alt="Name" src="https://i.imgur.com/10.png"/> at <img alt="Name" src="https://i.imgur.com/11.png"/> or Special Agent <img alt="Name" src="https://i.imgur.com/12.png"/> at <img alt="Name" src="https://i.imgur.com/13.png"/> with any questions.
