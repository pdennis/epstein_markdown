...
Date: Mon, 06 Jul 2020 13:21:24 +0000

Thanks. And definitely get it. I think [REDACTED] is just trying to be as up-to-date as possible when she raises.

From: [REDACTED] <br/>
Sent: Monday, July 6, 2020 9:20 AM
...
I tried using the exe file a couple times and it crashed my computer both times. But I can follow up with FBI. And in any event these two devices are a tiny percentage overall, and not the ones we expect may have useful evidence in connection with Maxwell — for that we want the servers with old emails, rather than devices purchased and used years after Maxwell was out of the picture.

Sent from my iPhone

On Jul 6, 2020, at 09:17, [REDACTED] <usanys> <br/>

Okay, have you asked FBI if they can help? The more recent phone dumps I've gotten require me to open the data using a special program that typically comes with the extraction.
...
There just doesn't appear to be a PDF report like we normally see (and like there is for the other device). If [REDACTED] were around I'd give it to him to decipher, but in terms of what we got, it's not obvious to me where the actual data is.

Sent from my iPhone

On Jul 6, 2020, at 08:54, [REDACTED] <usanys> <br/>

Also, what is the issue with the iPhone extraction the FBI gave us — is it a bad extraction? Is it a technology issue? [REDACTED] is pushing up the chain this morning. Thanks
...
Subject: RE: Epstein search warrant documents</usanys></usanys></usanys></usanys></usanys></usanys></usanys></usanys></usanys></usanys></usanys></usanys>

Just to confirm, this estimate is for everything from both SWs, right? It looks like the attached email contemplates 57 devices, and it sounds like we're just over 60 at this point, but I assume that's an issue we could resolve with pretty easily if need be?
...
On Jun 29, 2020 12:56 PM, " [REDACTED]" <wrote: "="" "="" " src="https://latex.codecogs.com/svg.latex?\large\wrote"/> wrote: Great, thanks. Is there even a rough estimate of when we will get the USVI materials? Or an estimate of when you'll be able to see how many items to export, so we'll have a better sense of when we'll get those?
...
On Jun 29, 2020 12:52 PM, " [REDACTED]" <wrote: "="" "="" "="" "="" "="" "="" "="" " <table="" ,="" ,="" and="" ask="" begin,="" but="" by="" cell="" ckay,="" cell="" deay,="" document="" each="" error="" from:="" has,="" in="" is="" it="" june="" make="" new="" of="" on="" press="" questions="" qu're="" rw="" send="" sorting="" survey="" the="" this="" to="" unsw="" wrote:="" write:="" write:="" write:="" write:="" write:="" wrote:="" write:="" write:="" write:="" wrote:="" write:="" wrote:="" write:="" wrote:="" write:="" wrote:="" write:="" write:="" write:="" write:="" write:="" write:="" write:="" X="">1 <table="" (usanys)="" (usanys)="" (usansy)="" <table="" <table="" <table="" <table="" <table="" <table)="" <table) <table) <table) <table) <table) <table) <table) <table) <table) <table) <table) <table) <table) <table) <table>
...
On Jun 29, 2020 12:40 PM, "  $\text{一} ^ { \text{一} }$  "  $\text{一} ^ { \text{一} }$  wrote:
...
On Jun 29, 2020 11:03 AM, "  $\text{一} ^ { \text{一} }$  "  $\text{一} ^ { \text{一} }$  wrote:
...
Cc: [REDACTED] (USANYS) &lt;[REDACTED]&gt;; [REDACTED] (NY) (FBI) &lt;[REDACTED]&gt;; [REDACTED] (USANYS) &lt;[REDACTED]&gt;
...
On Jun 19, 2020 1:09 PM, "[REDACTED]" &lt;[REDACTED]&gt; wrote: [REDACTED], following up on the below – please let us know? Given case developments in recent days, this has become urgent. Thanks.
...
Cc: [REDACTED] (NY) (FBI) &lt;[REDACTED]&gt;; [REDACTED] (USANYS) &lt;[REDACTED]&gt;; [REDACTED] (USANYS) &lt;[REDACTED]
...
process—by which I just mean converting into file formats that are loadable onto Relativity. It doesn't really have anything to do with the taint review—we have to have access to the docs in our systems for discovery purposes.
...
To: [REDACTED] (NY) (FBI) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;;&lt;[REDACTED]
Cc: [REDACTED] (USANYS) [Contractor] &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;.
(FB1) &lt;[REDACTED]&gt;
...
To: [REDACTED] (USANYS) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;;&lt;[REDACTED]
Cc: [REDACTED] (USANYS) [Contractor] &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;; (USANYS) &lt;[REDACTED]&gt;.
(FB1) &lt;[REDACTED]&gt;
...
On May 8, 2020 1:58 PM, "_______________________" &lt;_______________________&gt; wrote:
...
From: _________________________, (NY) (FBI) &lt;_______________________&gt;
Sent: Friday, May 08, 2020 13:50
To: _________________________ (USANYS) &lt;_______________________&gt;; _________________________ (NY) (FBI) &lt;_______________________&gt;; _________________________ (USANYS) &lt;_______________________&gt;;
Cc: _________________________ (USANYS) [Contractor] &lt;_______________________&gt;; _________________________ (NY) (FBI) &lt;_______________________&gt;.
Subject: RE: Epstein search warrant documents
...
Also, _________________________, please reach out to me at one of the numbers below so we can brain storm. Thanks.

NY CART Coordinator
Senior Forensic Examiner
_______________________ cell
_______________________ desk

On May 8, 2020 12:10 PM, "_______________________" &lt;_______________________&gt; wrote:
_________________________

Following up on the below, I think you had said you expected to be able to get us a list of the devices seized from the search warrants at Epstein’s residences in New York and the USVI, as well as from his person upon arrest, in about a month (during our conference call a month ago) – so wanted to check if we can still expect that very soon? We’re waiting on that list to be able to do an updated search warrant on all of those devices. Please let us know the current timeline – and also the current timeline on producing the results from those August and September searches? I think you and _________________________ were going to coordinate on that, and you had mentioned you expected we’d have it a couple months from our call, which would be about a month from now. Wanted to make sure we’re still on track.
...
To: _________________________ (NY) (FBI) &lt;_______________________&gt;; _________________________ (USANYS) &lt;_______________________&gt;;
...
To: (NY) (FBI) &lt;;&gt;; &gt;; (USANYS) &lt;;&gt;; &gt;; (NY) (FBI) &lt;;&gt;; &gt;; (USANYS) &lt;;&gt;; &gt;; &lt;;&gt;; &gt;; (USANYS) [Contractor] &lt;;&gt;; &gt;; &lt;;&gt;; &gt;; &lt;;&gt;; &gt;; &lt;;&gt;; &gt;; (NY) (FBI) &lt;;&gt;
...
From: [REDACTED] [mailto: [mailto: [mailto: [mailto: [mailto: [mailto: [mailto: [[mailto: [[mailto: [[mailto: [[mailto: [[mailto: [[mailto: [[

cell desk

On Mar 2, 2020 11:15 AM, "________________")" &lt;________________&gt; wrote:
...
To: ___________________________ (NY) (FBI) &lt;________________&gt;; ___________________________ (USANYS) &lt;________________&gt;; ___________________________ (NY) (FBI) &lt;________________&gt;; ___________________________ (USANYS) &lt;________________&gt;

Cc: ___________________________ (USANYS) [Contractor] &lt;________________&gt;; ___________________________ &lt;________________&gt;; ___________________________ (USANYS) &lt;________________&gt;

(FBI) &lt;________________&gt;
...
From: ___________________________ (NY) (FBI) &lt;________________&gt;

Sent: Monday, February 24, 2020 09:24

To: ___________________________ (USANYS) &lt;________________&gt;; ___________________________ &lt;________________&gt;; ___________________________ (NY) (FBI) &lt;________________&gt;; ___________________________ (USANYS) &lt;________________&gt;
...
To: __________________________________________________________________________________________ (NY) (FBI) &lt;______________________________&gt;; __________________________________________________________________________________________ (NY) (FBI) &lt;______________________________&gt;;
Cc: __________________________________________________________________________________________ (USANYS) [Contractor] &lt;______________________________&gt;; __________________________________________________________________________________________ &lt;______________________________&gt;; __________________________________________________________________________________________
Subject: RE: Epstein search warrant documents

I’m not sure who’s the exact right person to ask this, so wanted to get everybody on one email chain about it – I have the hard drive that ___________ dropped off that has new Epstein search warrant materials, but it looks like there are also old materials (that I think we had previously received and uploaded??) on the hard drive, and so I’m not sure what’s new.

Just generally, and ___________ and I talked about this last week too, but it’s basically impossible for us to keep track of what we’re getting, and what has been completed, without some kind of identification or labeling system, along with a list of which devices have been extracted and downloaded.
